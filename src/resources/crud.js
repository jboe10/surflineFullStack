...
module.exports.updateOneByEmail = model => ({updateOneByEmail: updateOneByEmail(model)});
module.exports.getOnePrime = model => ({getOnePrime: getOnePrime(model)});
module.exports.updateOnePrime = model => ({updateOnePrime: updateOnePrime(model)});
module.exports.removeOnePrime = model => ({removeOnePrime: removeOnePrime(model)});
