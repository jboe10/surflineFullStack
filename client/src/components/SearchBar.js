    ...
    <>
      <div className="search-bar">
        <div className="home-button">
          <a href="/">
            <img src={surfline} className="large-logo" height="56px" width="120px" alt="ff"/>
            <img src={surflineSmall} className="small-logo" height="56px" width="56px" alt="ff"/>
          </a>
        </div>
        <div 
        ...
        <a className="free-trial-btn" href="/join">START FREE TRIAL</a>
