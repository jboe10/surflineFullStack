...
import { faPlusCircle, faMinusCircle, faArrowLeft, faArrowRight } from '@fortawesome/free-solid-svg-icons';
    ...
    <>
      <div className="cam-select">
        ...
        <div className="arrows">
          <button onClick={() => scroll(favsEle.current, -500)}>
      ...
      <div className="nav-links-mobile">
        ...
        <a href="/news">News</a>
        <a href="/join" className="sign-up-now">Sign Up</a>
      </div>
      {showAddSpots && (
        <AddFavoriteSpots
          setShow={setShowAddSpots}
        />
      )}
    </>
  )
